...
ROLEIDCLIENT = 1027007767048880213 #id du client
ROLEOWNERID = 1027008577807851621 #id de l'owner
ROLEBLACKLISTUSER = 1027008577807851621 #id du role qui peuvent pas utiliser le bot
...
async def on_ready():
    ...
    os.system("cls")
    activitybot = activity=discord.Activity(type=discord.ActivityType.listening, name="?help | Search Engine")
